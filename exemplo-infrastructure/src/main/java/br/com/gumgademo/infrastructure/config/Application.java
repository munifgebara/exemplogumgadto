...
@Configuration
@ComponentScan(basePackages = {"br.com.gumgademo", "io.gumga"})
@EnableJpaRepositories(repositoryFactoryBeanClass = GumgaRepositoryFactoryBean.class, basePackages = {"br.com.gumgademo", "io.gumga"})
...
public class Application {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga.domain","br.com.gumgademo");

package br.com.gumgademo.exemplo.boot;
...
@SpringBootApplication(scanBasePackages = {"br.com.gumgademo.exemplo.boot.components",
                                           "br.com.gumgademo.exemplo.application.service",
                                           "io.gumga",
                                           "br.com.gumgademo.exemplo.api"})
@EnableJpaRepositories(repositoryFactoryBeanClass = GumgaRepositoryFactoryBeanForSpringBoot.class, basePackages = {"br.com.gumgademo.exemplo.application.repository", "io.gumga"})
...
public class Application {
    ...
    public DataSource dataSource() {
        ...
        config.addDataSourceProperty("url", getProperties().getProperty("dataSource.url", "jdbc:h2:mem:exemplo;MVCC=true"));
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource dataSource) {
        ...
        factory.setPackagesToScan("io.gumga.domain", "br.com.gumgademo.exemplo.domain.model");
